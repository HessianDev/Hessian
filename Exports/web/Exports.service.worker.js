...
/** @type {string} */
const CACHE_VERSION = '1788626020|11349999';
/** @type {string} */
const CACHE_PREFIX = 'Hessian (robosim-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Exports.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Exports.html","Exports.js","Exports.offline.html","Exports.icon.png","Exports.apple-touch-icon.png","Exports.audio.worklet.js","Exports.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Exports.wasm","Exports.pck","Exports.side.wasm"];
